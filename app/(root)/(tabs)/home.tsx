...
//   // const handleSignOut = () => {router.push("/(root)/find-ride"); };
//   // const handleSignOut = () => {router.push("/(auth)/welcome"); };
//   const handleSignOut = () => {
//       signOut();
...
//         }}
//         ListEmptyComponent={() => (
//           <View className="fle flex-col items-center justify-center">
//             {!loading ? (
//               <>
...
// addinging confiramtion dialogue box for logout 
