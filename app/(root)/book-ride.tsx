    ...
    return (
        ...
        <RideLayout title="Book Ride">
            <>
                ...
                email={user?.emailAddresses[0].emaiilAddress!}
...
*/
// sovling eror while bookign time errooo 
...
import RideLayout from "@/components/RideLayout";
import { icons } from "@/constants";
import { convertToINR, formatTime } from "@/lib/utils";
import { useDriverStore, useLocationStore } from "@/store";
...
const BookRide = () => {
  ...
  if (!driverDetails) {
    return <Text>Driver details not found</Text>;
  }
        ...
        <>
          ...
          <View className="flex flex-col w-full items-start justify-center py-3 px-5 rounded-3xl bg-general-600 mt-5">
            <View className="flex flex-row items-center justify-between w-full border-b border-white py-3">
              <Text className="text-lg font-JakartaRegular">Ride Price</Text>
              <Text className="text-lg font-JakartaRegular text-[#0CC25F]">
                {/* ${driverDetails.price} testing */}
            ₹ {convertToINR(driverDetails.price).toFixed(2)}
