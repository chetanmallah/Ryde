            ...
            <View className="flex flex-row items-center justify-between">
                <Image
                    source={{
                        ...
                        .com/v1/staticmap?style=osm-bright&width=600&height=400&center=lonlat:${destination_longitude}, ${destination_latitude}&zoom=14&apiKey=${process.env.EXPO_PUBLIC__GEOAPIFY_API_KEY}`,
